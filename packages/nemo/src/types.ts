...
// ProxyConfig is an alias for MiddlewareConfig to support both middleware.ts and proxy.ts naming
// In Next.js 16+, ProxyConfig is the same as MiddlewareConfig
