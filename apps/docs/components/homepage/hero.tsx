...
function Content() {
  return (
    <div className="md:absolute p-8 md:p-0 inset-0 flex flex-col items-start justify-center md:grid grid-cols-12 grid-rows-4 md:grid-rows-6">
      ...
      <div className="col-span-12 md:col-span-8 flex flex-col items-start justify-end mt-6 md:mt-0 md:w-full h-full gap-4 lg:flex-row lg:items-center lg:justify-start lg:gap-8">
