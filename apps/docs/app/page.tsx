  ...
  return (
    <main className="relative max-w-5xl mx-auto border my-[150px] bg-background divide-y divide-muted">
      ...
      <div className="grid lg:grid-cols-3 bg-muted gap-x-px">
        ...
        <div className="p-4 lg:px-8 lg:py-12 bg-background flex flex-col items-start justify-start gap-6">
          <h2 className="text-3xl font-bold text-muted-foreground">Supports</h2>
