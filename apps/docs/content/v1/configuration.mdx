...
**Type**: [`Record<string, MiddlewareFunction | MiddlewareFunction[]>`](/docs/v1/functions)
...
**Type**: [`MiddlewareFunction | MiddlewareFunction[]`](/docs/v1/functions)
...
<Card href="/docs/v1/functions" title="Functions" description="Learn more about NEMO Functions" icon={<PlayIcon/>}/>

## Global middlewares construction (`globalMiddlewares`)

**Type**: [`Record<"before" | "after", MiddlewareFunction | MiddlewareFunction[]>`](/docs/v1/functions)
