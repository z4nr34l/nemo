...
<Steps>
  ...
  <Step>
    ...
    <Cards>
      <Card href="/docs/1.4.0/configuration" title="Configuration" description="Learn more about middlewres configuration" icon={<WrenchIcon/>}/>
      <Card href="/docs/1.4.0/functions" title="Functions" description="Learn more about middlewre functions" icon={<SquareFunctionIcon/>}/>
    </Cards>
  </Step>
  <Step>
