...
<Steps>
  ...
  <Step>
    ...
    <Cards>
      <Card href="/docs/v1.4.0/configuration" title="Configuration" description="Learn more about middlewres configuration" icon={<WrenchIcon/>}/>
      <Card href="/docs/v1.4.0/functions" title="Functions" description="Learn more about middlewre functions" icon={<SquareFunctionIcon/>}/>
    </Cards>
  </Step>
  <Step>
...
Hope it will save you some time and would make your project DX better!import { SquareFunctionIcon, WrenchIcon } from "lucide-react";
import { Step, Steps } from 'fumadocs-ui/components/steps';
