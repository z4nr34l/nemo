...
<Steps>
  ...
  <Step>
    ...
    <Cards>
      <Card href="/docs/v3/configuration" title="Configuration" description="Learn more about middlewres configuration" icon={<WrenchIcon/>}/>
      <Card href="/docs/v3/functions" title="Functions" description="Learn more about middlewre functions" icon={<SquareFunctionIcon/>}/>
    </Cards>
