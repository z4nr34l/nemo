...
description: Get started with next-easy-middlewares
icon: Book
---
...
<Steps>
  ...
  <Step>
    ...
    <Cards>
      <Card href="/docs/api-reference/configuration" title="Configuration" description="Learn more about middlewres configuration" icon={<WrenchIcon/>}/>
      <Card href="/docs/api-reference/functions" title="Functions" description="Learn more about middlewre functions" icon={<SquareFunctionIcon/>}/>
    </Cards>
  </Step>
  <Step>
    ...
    <Callout>
      Reed more about [Next.js middleware configuration](https://nextjs.org/docs/app/api-reference/file-conventions/middleware#config-object-optional)
    </Callout>
  </Step>
  <Step>
